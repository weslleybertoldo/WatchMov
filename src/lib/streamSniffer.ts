...
export interface SniffResult { url: string; mime?: string; referer?: string; quality?: string; headers?: Record<string, string>; provider?: string; option?: string; synthetic?: boolean; ephemeral?: boolean }
