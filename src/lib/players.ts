...
export const PROVIDERS: Provider[] = [
  ...
  // PlayerFlix e WarezCDN testados 01/07 e REMOVIDOS: PlayerFlix (playerflixapi.com)
  // só toca embedado ("conteúdo disponível apenas via iframe") → black no player
  // nativo; warezcdn.link/filme = página de propaganda, não player.
];
